...
const UpdateEmployee = () => {
	...
	const {id} = useParams(); // Deconstructed id from params
		...
		<div className='flex max-w-2xl mx-auto shadow border-b'>
			<div className='px-8 py-8'>
				...
				<div className='items-center justify-center h-14 w-full pt-4 my-4 space-x-4'>
					<button className='rounded text-white font-semibold bg-green-500 hover:bg-green-800 py-2 px-6' onClick={updateEmployee}>
						Update
					</button>
